...
const quests = [
  { title: 'Software Engineer Intern', org: 'Dimelco S.A.S', location: 'Cúcuta, Colombia', duration: 'May 2024 - Aug 2024', reward: 'DEV + CLOUD EXP', color: 'bg-amber-400', details: ['Developed prototype landing pages and employee management UI with JS, HTML, CSS, React, and TypeScript.', 'Engineered Python REST APIs and SQL queries validated through GitHub Actions CI/CD on AWS.', 'Leveraged LLMs and agentic AI workflows under senior engineering mentorship.'] },
  { title: 'Freelancer Software Engineer', org: 'Self Employed / Freelance', location: 'Remote', duration: 'June 2026 - Aug 2026', reward: 'WEB + CLOUD EXP', color: 'bg-amber-400', details: ['Developed prototype landing pages and employee management UI with JS, HTML, CSS, React, and TypeScript.', 'Engineered Python REST APIs and SQL queries validated through GitHub Actions CI/CD on AWS.', 'Leveraged LLMs and agentic AI workflows under senior engineering mentorship.'] },
  { title: 'Learning Assistant', org: 'University of Central Florida Mathematics Lab', location: 'Orlando, FL', duration: 'August 2026 - Present', reward: 'Teaching EXP', color: 'bg-cyan-400', details: ['Learning Assistant for University of Central Florida Mathematics and Assistance Learning Lab for Calculus I, PreCalculus, Trigonometry, Algebra'] },
  { title: 'Teaching Assistant', org: 'University of Central Florida Department of CS', location: 'Orlando, FL', duration: 'May 2025 - August 2026', reward: 'Teaching EXP', color: 'bg-cyan-400', details: ['Mentoring 200+ students per semester in Data Structures, Algorithms, and Object-Oriented Programming using C and Java.', 'Designing supplementary lab exercises, code-debugging workshops, and exam review materials.'] },
  { title: 'Undergraduate Research Assistant', org: 'University of Central Florida APPLeSeed Lab', location: 'Orlando, FL', duration: 'January 2025 - April 2025', reward: 'Low Level Systems EXP', color: 'bg-amber-400', details: ['Developed prototype landing pages and employee management UI with JS, HTML, CSS, React, and TypeScript.', 'Engineered Python REST APIs and SQL queries validated through GitHub Actions CI/CD on AWS.', 'Leveraged LLMs and agentic AI workflows under senior engineering mentorship.'] },
