...
function PokemonParty() {
  return <aside className="border-4 border-slate-900 bg-slate-50 p-3 shadow-[5px_5px_0px_0px_#38405f]" aria-label="Xavier's PokÃ©mon companion party">
...
function LegacyPokedexCard() {
  ...
  return <section id="projects" className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8"><SectionTitle kicker="[SECTION 02]">POKÃ‰DEX PROJECT SHOWCASE</SectionTitle><div className="border-4 border-slate-900 bg-rose-400 p-3 shadow-[8px_8px_0px_0px_#0f172a] sm:p-5"><div className="grid gap-5 lg:grid-cols-[230px_1fr]">
